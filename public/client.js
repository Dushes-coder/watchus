...
// Инициализация глобальных переменных для совместного использования с games.js
window.socket = io();
window.roomId = null;
...
function updateGlobalRoomId(rid) { window.roomId = rid; roomId = rid; }
let player = window.player;
let isSeekingProgrammatically = window.isSeekingProgrammatically;
let timeUpdater = window.timeUpdater;
let hlsInstance = window.hlsInstance;
let youtubePlayer = window.youtubePlayer;
let ytPolling = window.ytPolling;
